...
instance_create_layer(x, y, "instances", shipDestroyed,
{
...
if(canProduce || canResearch)
{
	...
	ds_list_destroy(production);
	ds_list_destroy(productionAmount);
	ds_list_destroy(fullProduction);
	ds_list_destroy(energyProduction);
}

if(canResearch)
{
	ds_list_destroy(unitAffected);
}
