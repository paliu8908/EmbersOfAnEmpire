...
if(constructing)
{
	...
	draw_rectangle_color(x + sprite_width/2, y - 5 - sprite_height, x - sprite_width/2 + sprite_width/construct_time * construct_counter, y - 8 - sprite_height, c_white, c_white, c_white, c_white, false);
}