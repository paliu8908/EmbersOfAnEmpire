...
if(keyboard_check(vk_shift))
{
	...
	{
		if(ds_list_find_index(global.squad1, ds_list_find_value(global.selection, i)) == -1)
		{
			ds_list_add(global.squad1, ds_list_find_value(global.selection, i));
		}
	}
}
else if(keyboard_check(vk_control))
{
	...
	ds_list_copy(global.squad1, global.selection);
}

if(ds_list_size(global.squad1) > 0)
{
	
	ResetSelection();
	
	for(var i = 0; i < ds_list_size(global.squad1); i++)
	{
		var _troop = ds_list_find_value(global.squad1, i);
