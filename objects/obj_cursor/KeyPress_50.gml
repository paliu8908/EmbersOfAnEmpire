...
if(keyboard_check(vk_shift))
{
	...
	{
		if(ds_list_find_index(global.squad2, ds_list_find_value(global.selection, i)) == -1)
		{
			ds_list_add(global.squad2, ds_list_find_value(global.selection, i));
		}
	}
}
...
else if(keyboard_check(vk_control))
{
	...
	ds_list_copy(global.squad2, global.selection);
}

if(ds_list_size(global.squad2) > 0)
{
	
	ResetSelection();
	
	for(var i = 0; i < ds_list_size(global.squad2); i++)
	{
		var _troop = ds_list_find_value(global.squad2, i);
