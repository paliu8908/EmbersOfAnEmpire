...
if(keyboard_check(vk_shift))
{
	...
	{
		if(ds_list_find_index(global.squad4, ds_list_find_value(global.selection, i)) == -1)
		{
			ds_list_add(global.squad4, ds_list_find_value(global.selection, i));
		}
	}
}
else if(keyboard_check(vk_control))
{
	...
	ds_list_copy(global.squad4, global.selection);
}

if(ds_list_size(global.squad4) > 0)
{
	
	ResetSelection();
	
	for(var i = 0; i < ds_list_size(global.squad4); i++)
	{
		var _troop = ds_list_find_value(global.squad4, i);
