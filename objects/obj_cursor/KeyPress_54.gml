...
if(keyboard_check(vk_shift))
{
	...
	{
		if(ds_list_find_index(global.squad6, ds_list_find_value(global.selection, i)) == -1)
		{
			ds_list_add(global.squad6, ds_list_find_value(global.selection, i));
		}
	}
}
else if(keyboard_check(vk_control))
{
	...
	ds_list_copy(global.squad6, global.selection);
}

if(ds_list_size(global.squad6) > 0)
{
