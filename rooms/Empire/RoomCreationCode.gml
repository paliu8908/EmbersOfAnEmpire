...
ds_list_add(global.factions, "ai", "player",);
...
ds_list_add(global.metal, 5000, 5000);
...
for(var a = 0; a < 1; a++)
{
	//var mate = instance_create_layer(1000 + a%4 * 75, 1000 + 100 * floor(a/4), "instances", Prox_Hegemon_Carrier);
...
for(var a = 0; a < 9; a++)
{
	//var mate = instance_create_layer(1000 + a%4 * 75, 1000 + 100 * floor(a/4), "instances", Prox_Mech_Brusier);
	//mate.faction_number = ds_list_find_index(global.factions, "player");
...
for(var e = 0; e < 1; e++)
{
	//var _uni = instance_create_layer(2000 -  e % 4 * 100, 2000 - 100* floor(e/4), "instances", Ark_Hapten_Dreadnought);
...
var carrier = instance_create_layer(300, 500, "instances", Prox_Hegemon_Carrier);

var temp = instance_create_layer(300, 500, "instances", Prox_Hangar, 
{
	shift_x : carrier.modules[0, 1], 
	shift_y : carrier.modules[0, 2],
	owner : carrier,
	module_num : 0,
	depth : carrier.depth - 50
});

carrier.modules[0, 0] = temp;

var temp = instance_create_layer(300, 500, "instances", Prox_Support_Bay, 
{
	shift_x : carrier.modules[1, 1], 
	shift_y : carrier.modules[1, 2],
	owner : carrier,
	module_num : 1,
	depth : carrier.depth - 50
});

carrier.modules[1, 0] = temp;

instance_create_layer(500, 500, "instances", com_asteroid_large);
...
instance_create_layer(0, 0, "instances", Prox_Demo);