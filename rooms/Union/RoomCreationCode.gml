...
// 12 - Tau Ceti, 13 - Hapten, 14 - Dappist, 16 -  Kepler -> Experimental Centre

var ui = instance_create_layer(2100, 1324, "instances", UI_Back);
...
instance_create_layer(1000, 1000, "instances", Ark_HQ);
